...
export type adminWhereInput = {
  ...
  user_id?: Prisma.IntFilter<"admin"> | number
...
export type adminScalarWhereWithAggregatesInput = {
  ...
  user_id?: Prisma.IntWithAggregatesFilter<"admin"> | number
}

export type adminCreateInput = {
  users: Prisma.usersCreateNestedOneWithoutAdminInput
}
...
export type adminUpdateInput = {
  users?: Prisma.usersUpdateOneRequiredWithoutAdminNestedInput
}
...
export type adminOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"user_id", ExtArgs["result"]["admin"]>
...
export interface adminDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const adminWithUser_idOnly = await prisma.admin.createManyAndReturn({
   *   select: { user_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const adminWithUser_idOnly = await prisma.admin.updateManyAndReturn({
   *   select: { user_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface adminFieldRefs {
  readonly user_id: Prisma.FieldRef<"admin", 'Int'>
}
